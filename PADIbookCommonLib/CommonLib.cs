...
namespace PADIbookCommonLib
{
    ...
    public delegate void RemoteAsyncShareObjectDelegate(ObjectFile file, String uri, DateTime nounce, String contactingUri, String lowest);
    ...
    public interface ServerToServerServices
    {
        ...
        void shareObject(ObjectFile file, String uri, DateTime nounce, String contactingUri, String lowest);
        //void lookupSexAge(QueryByGenderAge q);
